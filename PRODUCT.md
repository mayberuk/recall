...
Success is a lookup that would otherwise have cost a long, failed grep — answered in milliseconds,
...
- **The name is lowercase `recall`** — binary, prose, and docs, without exception. Confirmed
